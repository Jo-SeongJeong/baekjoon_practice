...
public class BJ16236 { // 메모리 : 18668kb, 시간 : 232ms
    static int n;
    static int sr = 0;
    static int sc = 0;
    static int time;
    ...
    private static boolean bfs(int sr, int sc, int shark) {
        int level = 0;
        int[][] delta = new int[][] {{-1, 0}, {0, -1}, {0, 1}, {1, 0}}; // 우선순위 고려, 상좌우하 순
